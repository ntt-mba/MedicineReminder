...
public class PickerTimerFragment extends BottomSheetDialogFragment {
    ...
    private int mPositionHour = -1;
    private int mPositionMinute = -1;
    ...
    private ArrayList<String> optionsHour = new ArrayList<>();
    private ArrayList<String> optionsMinute = new ArrayList<>();
